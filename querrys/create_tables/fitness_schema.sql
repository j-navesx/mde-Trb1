...
ALTER TABLE exercises
    ADD CONSTRAINT exercises_act_temp_fk FOREIGN KEY ( activities_template_act_id )
...
ALTER TABLE friends_leaderboard
    ADD CONSTRAINT fl_user_fk FOREIGN KEY ( fit_user_id )
        REFERENCES fit_user ( id );
