...
ALTER TABLE friends_list ADD CONSTRAINT friends_list_pk PRIMARY KEY ( fit_user_id2,
                                                                      fit_user_id );
...
ALTER TABLE friends_list
    ADD CONSTRAINT friends_list_fit_user_fkv2 FOREIGN KEY ( fit_user_id2 )
        REFERENCES fit_user ( id )
    NOT DEFERRABLE;
