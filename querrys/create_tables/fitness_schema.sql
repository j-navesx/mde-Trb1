...
ALTER TABLE friends_list ADD CONSTRAINT friends_list_pk PRIMARY KEY ( fit_user_id1,
                                                                      fit_user_id );
...
ALTER TABLE friends_leaderboard
    ADD CONSTRAINT f_l_totals_fk FOREIGN KEY ( totals_fit_user_id,
                                               totals_activities_template_id )
...
ALTER TABLE friends_list
    ADD CONSTRAINT friends_list_fit_user_fkv1 FOREIGN KEY ( fit_user_id1 )
        REFERENCES fit_user ( id )
            ON DELETE CASCADE
    NOT DEFERRABLE;
